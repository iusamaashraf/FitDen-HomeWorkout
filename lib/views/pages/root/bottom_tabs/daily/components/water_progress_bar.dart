...
class WaterCircularProgressBar extends StatefulWidget {
  const WaterCircularProgressBar({Key? key}) : super(key: key);

  @override
  State<WaterCircularProgressBar> createState() =>
      _WaterCircularProgressBarState();
}

class _WaterCircularProgressBarState extends State<WaterCircularProgressBar> {
    ...
    return const SafeArea(
      child: Scaffold(
        body: SizedBox.expand(
            ...
            //                   GetX<BasicController>(
            //                     init: BasicController(),
            //                     builder: (con) {
            //                       return Text(
            //                           con.getwater.numberofglass.toString());
            //                     },
            //                   ),
